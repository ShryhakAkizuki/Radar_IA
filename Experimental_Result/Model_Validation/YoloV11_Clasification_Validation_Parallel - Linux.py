...
if __name__ == "__main__":
    ...
    num_workers  = math.floor(mp.cpu_count() *3/4)                                                                          # Cantidad de procesos que se crean
    ...
    output_path  = f"../YoloV11_Clasification-Results_RaspberryPi5_Batch_{batch_size}_parallelV2_{num_workers}_workers.csv" # Ruta donde se exportaran los resultados
