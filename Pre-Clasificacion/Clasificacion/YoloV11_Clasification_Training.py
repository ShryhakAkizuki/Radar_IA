# -*- coding: utf-8 -*-
"""
Script para realizar el entrenamiento del modelo de clasificacion de YOLOV11
...
if __name__ == "__main__":
    ...
    # -------- Variables ------------------------------------------------------------
    csv_path    = "..\\Registros_Clasificados_Asistido_Auditados.csv"       # Ruta de la carpeta donde se encuentra el archivo CSV
    output_dir  = "..\\Model_Training\\YoloV11_Semi-Clasification_Test2"    # Ruta donde se copiara el Dataset en el formato adecuado
    ...
    YOLO_Training(output_dir,"Modelo_Entrenado") 